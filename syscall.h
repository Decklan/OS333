...
#define SYS_getuid      SYS_date+1         // p2
...
#define SYS_getprocs    SYS_setgid+1       // p2
#define SYS_setpriority SYS_getprocs+1     // p4
#define SYS_chmod       SYS_setpriority+1  // p5
#define SYS_chown       SYS_chmod+1        // p5
#define SYS_chgrp       SYS_chown+1        // p5
