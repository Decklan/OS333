...
printint(int fd, int xx, int base, int sgn)
{
 ...
 396:	0f b6 80 08 0a 00 00 	movzbl 0xa08(%eax),%eax
...
free(void *ap)
{
 ...
 59a:	a1 24 0a 00 00       	mov    0xa24,%eax
...
free(void *ap)
{
 ...
 665:	a3 24 0a 00 00       	mov    %eax,0xa24
}
 66a:	90                   	nop
 66b:	c9                   	leave  
 66c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 68c:	50                   	push   %eax
 68d:	e8 71 fc ff ff       	call   303 <sbrk>
 ...
 6c3:	83 c4 10             	add    $0x10,%esp
  return freep;
 6c6:	a1 24 0a 00 00       	mov    0xa24,%eax
}
 6cb:	c9                   	leave  
 6cc:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 6df:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 6e2:	a1 24 0a 00 00       	mov    0xa24,%eax
 6e7:	89 45 f0             	mov    %eax,-0x10(%ebp)
 6ea:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 6ee:	75 23                	jne    713 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 45 f0 1c 0a 00 00 	movl   $0xa1c,-0x10(%ebp)
 6f7:	8b 45 f0             	mov    -0x10(%ebp),%eax
 6fa:	a3 24 0a 00 00       	mov    %eax,0xa24
 6ff:	a1 24 0a 00 00       	mov    0xa24,%eax
 704:	a3 1c 0a 00 00       	mov    %eax,0xa1c
    base.s.size = 0;
 709:	c7 05 20 0a 00 00 00 	movl   $0x0,0xa20
 710:	00 00 00 
  }
 ...
 766:	a3 24 0a 00 00       	mov    %eax,0xa24
      return (void*)(p + 1);
 ...
 771:	eb 3b                	jmp    7ae <malloc+0xe1>
    ...
    if(p == freep)
 773:	a1 24 0a 00 00       	mov    0xa24,%eax
