...
int main(int argc, char *argv[])
{
  ...
  34:	68 25 09 00 00       	push   $0x925
  39:	6a 02                	push   $0x2
  3b:	e8 2f 05 00 00       	call   56f <printf>
  ...
  dc:	50                   	push   %eax
  dd:	68 32 09 00 00       	push   $0x932
  e2:	6a 01                	push   $0x1
  e4:	e8 86 04 00 00       	call   56f <printf>
  ...
  ff:	50                   	push   %eax
 100:	68 4c 09 00 00       	push   $0x94c
 105:	6a 01                	push   $0x1
 107:	e8 63 04 00 00       	call   56f <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50b:	0f b6 80 b8 0b 00 00 	movzbl 0xbb8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 647:	75 25                	jne    66e <printf+0xff>
          s = "(null)";
 649:	c7 45 f4 65 09 00 00 	movl   $0x965,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 70f:	a1 d4 0b 00 00       	mov    0xbd4,%eax
...
free(void *ap)
{
 ...
 7da:	a3 d4 0b 00 00       	mov    %eax,0xbd4
}
 7df:	90                   	nop
 7e0:	c9                   	leave  
 7e1:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 838:	83 c4 10             	add    $0x10,%esp
  return freep;
 83b:	a1 d4 0b 00 00       	mov    0xbd4,%eax
}
 840:	c9                   	leave  
 841:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 854:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 857:	a1 d4 0b 00 00       	mov    0xbd4,%eax
 85c:	89 45 f0             	mov    %eax,-0x10(%ebp)
 85f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 863:	75 23                	jne    888 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 865:	c7 45 f0 cc 0b 00 00 	movl   $0xbcc,-0x10(%ebp)
 86c:	8b 45 f0             	mov    -0x10(%ebp),%eax
 86f:	a3 d4 0b 00 00       	mov    %eax,0xbd4
 874:	a1 d4 0b 00 00       	mov    0xbd4,%eax
 879:	a3 cc 0b 00 00       	mov    %eax,0xbcc
    base.s.size = 0;
 87e:	c7 05 d0 0b 00 00 00 	movl   $0x0,0xbd0
 885:	00 00 00 
  }
 ...
 8db:	a3 d4 0b 00 00       	mov    %eax,0xbd4
      return (void*)(p + 1);
 ...
 8e6:	eb 3b                	jmp    923 <malloc+0xe1>
    ...
    if(p == freep)
 8e8:	a1 d4 0b 00 00       	mov    0xbd4,%eax
