...
int main(int argc, char *argv[])
{
  ...
  int f = fork(); 
  14:	e8 1d 04 00 00       	call   436 <fork>
  19:	89 45 f4             	mov    %eax,-0xc(%ebp)
  int before = uptime();
  1c:	e8 b5 04 00 00       	call   4d6 <uptime>
  ...
  34:	68 cb 09 00 00       	push   $0x9cb
  39:	6a 02                	push   $0x2
  3b:	e8 d5 05 00 00       	call   615 <printf>
  ...
  5d:	50                   	push   %eax
  5e:	e8 13 04 00 00       	call   476 <exec>
  63:	83 c4 10             	add    $0x10,%esp
  66:	e9 a4 00 00 00       	jmp    10f <main+0x10f>
  } else {
    wait();
  6b:	e8 d6 03 00 00       	call   446 <wait>
    after = uptime();
  70:	e8 61 04 00 00       	call   4d6 <uptime>
  ...
  dc:	50                   	push   %eax
  dd:	68 d8 09 00 00       	push   $0x9d8
  e2:	6a 01                	push   $0x1
  e4:	e8 2c 05 00 00       	call   615 <printf>
  ...
  ff:	50                   	push   %eax
 100:	68 f2 09 00 00       	push   $0x9f2
 105:	6a 01                	push   $0x1
 107:	e8 09 05 00 00       	call   615 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5b1:	0f b6 80 80 0c 00 00 	movzbl 0xc80(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6ed:	75 25                	jne    714 <printf+0xff>
          s = "(null)";
 6ef:	c7 45 f4 0b 0a 00 00 	movl   $0xa0b,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b5:	a1 9c 0c 00 00       	mov    0xc9c,%eax
...
free(void *ap)
{
 ...
 880:	a3 9c 0c 00 00       	mov    %eax,0xc9c
}
 885:	90                   	nop
 886:	c9                   	leave  
 887:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8de:	83 c4 10             	add    $0x10,%esp
  return freep;
 8e1:	a1 9c 0c 00 00       	mov    0xc9c,%eax
}
 8e6:	c9                   	leave  
 8e7:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8fa:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8fd:	a1 9c 0c 00 00       	mov    0xc9c,%eax
 902:	89 45 f0             	mov    %eax,-0x10(%ebp)
 905:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 909:	75 23                	jne    92e <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 90b:	c7 45 f0 94 0c 00 00 	movl   $0xc94,-0x10(%ebp)
 912:	8b 45 f0             	mov    -0x10(%ebp),%eax
 915:	a3 9c 0c 00 00       	mov    %eax,0xc9c
 91a:	a1 9c 0c 00 00       	mov    0xc9c,%eax
 91f:	a3 94 0c 00 00       	mov    %eax,0xc94
    base.s.size = 0;
 924:	c7 05 98 0c 00 00 00 	movl   $0x0,0xc98
 92b:	00 00 00 
  }
 ...
 981:	a3 9c 0c 00 00       	mov    %eax,0xc9c
      return (void*)(p + 1);
 ...
 98c:	eb 3b                	jmp    9c9 <malloc+0xe1>
    ...
    if(p == freep)
 98e:	a1 9c 0c 00 00       	mov    0xc9c,%eax
